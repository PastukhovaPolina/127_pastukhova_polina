...
public class Task3_Tests extends Assert {
    ...
    @Test
    public void heapSort_array_arraySame(){
    ...
    @Test
    public void heapSort_array_sort3Elements(){
        Integer[] array = new Integer[]{3,2,4};
        HeapSort<Integer> heapSort = new HeapSort();
        heapSort.sort(array, new TestComparator());
    ...
    public void heapSort_array_sort(){
        Integer[] array = new Integer[]{5,1,3,1,1,3};
        HeapSort<Integer> heapSort = new HeapSort();
        heapSort.sort(array, new TestComparator());
        assertArrayEquals(new Integer[]{1,1,1,3,3,5}, array);
    }
    @Test
    public void heapSort_array2_sort(){
        Integer[] array = new Integer[]{5,1,2,3,1,5,5,2};
        HeapSort<Integer> heapSort = new HeapSort();
        heapSort.sort(array, new TestComparator());

...
CREATE TABLE `userbooks` (
  ...
  KEY `_idx` (`BookId`),
  KEY `ub_idx` (`userId`),
  CONSTRAINT `bu` FOREIGN KEY (`BookId`) REFERENCES `books` (`id`),
  CONSTRAINT `ub` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
INSERT INTO `userbooks` VALUES (27,15,11,2),(28,15,12,2),(29,15,5,1),(30,6,11,3),(31,6,4,8),(32,6,6,14),(33,6,5,3),(34,18,11,2),(35,18,5,4),(36,18,7,1),(37,6,7,5),(38,6,12,3),(39,17,4,1);
